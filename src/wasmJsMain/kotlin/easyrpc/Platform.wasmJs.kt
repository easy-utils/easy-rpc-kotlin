...
/**
 * Wasm gzip via WHATWG `CompressionStream`/`DecompressionStream`. Kotlin/Wasm
 * `@JsFun` only permits primitive/string/function parameters, so bytes cross
 * as base64 strings.
 */
...
// Ktor's JS engine works for wasmJs too.
